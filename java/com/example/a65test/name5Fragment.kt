 ...
 * Use the [name5Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class name5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val name4 = inflater.inflate(R.layout.fragment_name5, container, false)
        val tv1: TextView = name4.findViewById(R.id.f_name)
        tv1.text = "Имя: Екатерина"
        val tv2: TextView = name4.findViewById(R.id.l_name)
        tv2.text = "Фамилия : Пертрова"
        val tv3: TextView = name4.findViewById(R.id.birthday)
        tv3.text = "Дата рождения: 1990-01-07 "
    ...
    companion object {
         ...
         * @return A new instance of fragment name5Fragment.
         */
