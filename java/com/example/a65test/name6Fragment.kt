 ...
 * Use the [name6Fragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class name6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val name4 = inflater.inflate(R.layout.fragment_name6, container, false)
        val tv1: TextView = name4.findViewById(R.id.f_name)
        tv1.text = "Имя: Николай"
        val tv2: TextView = name4.findViewById(R.id.l_name)
        tv2.text = "Фамилия : Сидоров"
    ...
    companion object {
         ...
         * @return A new instance of fragment name6Fragment.
         */
